...
# TODO: UrbanIDM???
function scenario_pedestrian_crosswalk(; init_noise_1::Noise=Noise(), init_noise_2::Noise=Noise(),
                                       s_sut::Float64=0.0, s_adv::Float64=8.0, v_sut::Float64=12.0, v_adv::Float64=2.0)
    ...
    sut = BlinkerVehicleAgent(cw_left_to_right(id=1, noise=init_noise_1, roadway=roadway, s=s_sut, v=v_sut), sut_model)
    ...
    adversary = NoisyPedestrianAgent(cw_pedestrian_walking_up(id=2, noise=init_noise_2, roadway=roadway, s=s_adv, v=v_adv), adversary_model)
