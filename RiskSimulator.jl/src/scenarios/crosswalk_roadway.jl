...
function cw_left_to_right(; roadway::Roadway, noise::Noise=Noise(), id::Int64=1, s::Float64=5.0, v::Float64=12.0, goals::Vector=[1], blinker::Bool=false)
...
function cw_pedestrian_walking_up(; roadway::Roadway, noise::Noise=Noise(), id::Int64=1, s::Float64=5.0, v::Float64=2.0)
