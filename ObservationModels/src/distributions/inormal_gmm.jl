...
Distributions.logpdf(d::INormal_GMM, x::Real) = Distributions.logpdf(Normal(d.mu, d.sigma), x) - Distributions.logpdf(UnivariateGMM(d.gmm_mu, d.gmm_sigma, d.gmm_prior), x)
